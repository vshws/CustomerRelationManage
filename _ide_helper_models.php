 ...
 * @property int|null $advanced_ticket
 * @property int|null $location_id
 * @property int|null $availability_id
 * @property string|null $memory
 * @property string|null $memory_value_from
 * @property string|null $memory_value_to
 * @property string|null $os
 * @property string|null $os_value
 * @property string|null $size
 * @property string|null $size_from
 * @property string|null $size_to
 * @property string|null $size_mon
 * @property string|null $size_mon_from
 * @property string|null $size_mon_to
 * @property string|null $size_keyboard_from
 * @property string|null $size_keyboard_to
 * @property string|null $size_mainboard_from
 * @property string|null $size_mainboard_to
 * @property string|null $size_housing_from
 * @property string|null $size_housing_to
 * @property string|null $memory_video_cards_from
 * @property string|null $memory_video_cards_to
 * @property string|null $amount_of_video_cards
 * @property string|null $support_contract_from
 * @property string|null $support_contract_to
 * @property-read int|null $activity_count
 * @property-read int|null $attachments_count
 * @property-read int|null $comments_count
 * @property-read \Modules\Platform\User\Entities\User|null $ticketOwner
 * @property-read int|null $tickets_count
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereAdvancedTicket($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereAmountOfVideoCards($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereAvailabilityId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereLocationId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereMemory($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereMemoryValueFrom($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereMemoryValueTo($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereMemoryVideoCardsFrom($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereMemoryVideoCardsTo($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereOs($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereOsValue($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereSize($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereSizeFrom($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereSizeHousingFrom($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereSizeHousingTo($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereSizeKeyboardFrom($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereSizeKeyboardTo($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereSizeMainboardFrom($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereSizeMainboardTo($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereSizeMon($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereSizeMonFrom($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereSizeMonTo($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereSizeTo($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereSupportContractFrom($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Tickets\Entities\Ticket whereSupportContractTo($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Calendar\Entities\Event whereContactId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Calendar\Entities\Event whereLeadId($value)
 */
 ...
 * @mixin \Eloquent
 */
	class BapTags extends \Eloquent {}
}
